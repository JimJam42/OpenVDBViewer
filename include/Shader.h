...
/// @file Shader.h
/// @brief Class to handle one shader component and handle its compilation and loading
/// @author Callum James
/// @version 1.0
/// @date 12/02/2014
/// Revision History:
...
/// @class Shader
/// @brief Shader class to handle a single shader component as part of a larger shader family. Controls
/// its compilation and loading and also the type of shader that it is
class Shader
{
public:
    ...
    /// @brief Return if the shader has been compiled or not - return true or false
...
private:
    ...
    // following two functions are utility functions designed to check and load the shaders from source
    // they will also check to see if it has compiled correctly
    // read in shader from source
